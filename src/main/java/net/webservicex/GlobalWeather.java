 ...
 * 2018-02-15T17:17:24.737+05:30
 * Generated source version: 3.2.2
 *
 */
@WebServiceClient(name = "GlobalWeather",
                  wsdlLocation = "file:/C:/code/demo/demo/src/main/resources/myService.wsdl",
...
public class GlobalWeather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/code/demo/demo/src/main/resources/myService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GlobalWeather.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/code/demo/demo/src/main/resources/myService.wsdl");
        }
        WSDL_LOCATION = url;
    }
